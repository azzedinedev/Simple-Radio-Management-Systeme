 ...
 */
    ...
    class Query_Request_DetailsPage extends Page
    {
    ...
    try
    {
        $Page = new Query_Request_DetailsPage("Query_Request_Details", "Query_Request_Details.php", GetCurrentUserPermissionSetForDataSource("Query Request Details"), 'UTF-8');
        $Page->SetTitle('Query Request Details');
        $Page->SetMenuLabel('Query Request Details');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Query Request Details"));
