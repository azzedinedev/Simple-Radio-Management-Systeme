 ...
 */
    ...
    class Query_Users_detailsPage extends Page
    {
    ...
    try
    {
        $Page = new Query_Users_detailsPage("Query_Users_details", "Query_Users_details.php", GetCurrentUserPermissionSetForDataSource("Query Users details"), 'UTF-8');
        $Page->SetTitle('Query Users Details');
        $Page->SetMenuLabel('Query Users Details');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Query Users details"));
